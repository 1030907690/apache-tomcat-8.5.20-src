    ...
    protected static class ConnectionHandler<S> implements AbstractEndpoint.Handler<S> {
        ...
        public SocketState process(SocketWrapperBase<S> wrapper, SocketEvent status) {
            ...
            try {
                ...
                do {
                	//重点调用 processor 的 process 方法处理 socket 
                	//而 processor 对象通过 createProcessor 方法创建出来的，createProcessor 方法在当前类里面是抽象方法，
                	//默认情况下调用的具体实现类在上面提到的 Http11ConnectionHandler(Tomcat7有,8应该是Http11NioProtocol) 类中
