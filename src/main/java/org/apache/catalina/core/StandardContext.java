...
public class StandardContext extends ContainerBase
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        try {
            ...
            //回调ServletContainerInitializer接口的的类  ，目前看到用这个做替换web.xml
            ...
            if (ok) {
            	System.out.println(" Load and initialize all \"load on startup\" servlets ");
    ...
    reloadable="true"
/>
       当这个 reloadable 设为 true 时，war 被修改后 Tomcat 会自动的重新加载这个应用。如何做到这点的呢 ? 
       这个功能是在 StandardContext 的 backgroundProcess 方法中实现的，这个方法的代码如下： 
     * */
    @Override
