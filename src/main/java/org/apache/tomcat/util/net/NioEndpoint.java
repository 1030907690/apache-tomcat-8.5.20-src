            ...
            try {
                ...
                if (handshake == 0) {
                    ...
                    if (event == null) {
                    	...
                    	//默认走这里调用 handler 对象的 process 方法，这里 handler 对象实际上是 Http11ConnectionHandler(Tomcat7有,8应该是Http11NioProtocol) 类的实例，
                    	//该对象的初始化过程是在   org.apache.coyote.http11.Http11Protocol对象的构造方法中
                    	/*
                    	       super(endpoint);
